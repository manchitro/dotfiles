...
new _webextOptionsSync.default().define({
  defaults: {
    ...
    autocollapsePaths: ['package-lock.json', 'yarn.lock', 'composer.lock'].join('\n'),
  ...
  }, _webextOptionsSync.default.migrations.removeUnused]
});
