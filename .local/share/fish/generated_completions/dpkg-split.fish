...
complete -c dpkg-split -l admindir -d 'Set the administrative directory to directory (since dpkg 1. 21. 10)'
complete -c dpkg-split -l root -d 'Set the root directory to directory (since dpkg 1. 21'
