...
complete -c deluser -l debug -d 'Activate debugging code'
...
complete -c deluser -l quiet -d 'Suppress informational messages, only show warnings and errors'
...
complete -c deluser -l verbose -d 'Be more verbose'
